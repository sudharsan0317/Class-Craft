...
export const INITIAL_CLASS_PROFILES = [
  {
    id: 'bio-10',
    ...
    notes: 'Focus on visual diagrams and inquiry-based discussions.'
  },
  {
    id: 'chem-8',
    ...
    notes: 'Hands-on lab experiments and conceptual definitions.'
  },
  {
    id: 'phys-12',
    ...
    studentsCount: 22,
    level: 'Advanced',
    notes: 'Numerical problem solving and board exam rigor.'
  }
];
...
export const useLessonStore = create((set, get) => ({
  ...
  user: null,
  login: (userData = { name: 'Siva Surya', email: 'sivasurya@classcraft.edu' }) =>
  ...
  classProfiles: INITIAL_CLASS_PROFILES,
  selectedClassId: 'bio-10',
  lastActiveClassId: null,
  setLastActiveClassId: (lastActiveClassId) => set({ lastActiveClassId }),
  classContext: INITIAL_CLASS_PROFILES[0],

  // Form Synchronization
  generatorForm: {
    subject: INITIAL_CLASS_PROFILES[0].subject,
    gradeLevel: INITIAL_CLASS_PROFILES[0].gradeLevel,
    learningObjective: '',
    duration: 45,
    sourceMaterialText: '',
    file: null,
