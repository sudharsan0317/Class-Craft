...
const DURATION_OPTIONS = [
  { label: '30 Minutes (Express)', value: 30 },
  { label: '45 Minutes (Standard)', value: 45 },
  { label: '60 Minutes (Extended)', value: 60 },
  { label: '90 Minutes (Block Period)', value: 90 }
];
...
export default function TeacherInputForm({ onGenerateSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        subject: generatorForm.subject.trim(),
        gradeLevel: generatorForm.gradeLevel,
        objectives: [generatorForm.learningObjective.trim()],
        duration: Number(generatorForm.duration) || 45,
        sourceMaterial: generatorForm.sourceMaterialText ? generatorForm.sourceMaterialText.trim() : '',
        fileName: generatorForm.file ? generatorForm.file.name : null,
